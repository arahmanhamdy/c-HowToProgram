...
int main(){
	int balance;
	int amount;
	cout << "Enter the balance of the first account: ";
	cin >> balance;
	Account firstAccount(balance);
	cout << "Enter the balance of the second account: ";
	cin >> balance;
	Account secondAccount(balance);
	cout << "Enter the amount you want to add to the first account: ";
	cin >> amount;
	firstAccount.credit(amount);
	cout << "Enter the amount you want to withdraw from the first account: ";
	cin >> amount;
